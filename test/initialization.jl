@testset "Initialization" begin
  ...
  @testset "NearestInit" begin
    ...
    real, mask = GeoStatsProcesses.initialize(proc, grid, data1D, init)
    ...
    real, mask = GeoStatsProcesses.initialize(proc, grid, data2D, init)
    ...
    real, mask = GeoStatsProcesses.initialize(proc, pset, data2D, init)
  ...
  @testset "ExplicitInit" begin
    ...
    real, mask = GeoStatsProcesses.initialize(proc, grid, data, init)
